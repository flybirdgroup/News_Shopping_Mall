...
class Goods(BaseModel):
    ...
    market_price = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='市场价')
    sell_price = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='销售价')
